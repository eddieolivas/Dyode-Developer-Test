  ...
  return (
    <div className="App">
      ...
      <div className={classes.categories}>
        ...
        <div className={classes.categoryCard}>
          <Link className={classes.accessoriesDesktop} to="/">
            <img alt="accessories" src={accessories} />
          </Link>
          <Link className={classes.accessoriesMobile} to="/">
            <img alt="accessories" src={accessoriesMobile} />
          </Link>
          <div className={classes.categoryTitle}>
      ...
      <div className={classes.followUs}>
        <div className={classes.container}>
          ...
          <div className={classes.instaPhotos}>
            <Link className={classes.instaPhoto} to="/">
              <img alt="Instagram post 1" src={insta1} />
            </Link>
            <Link className={classes.instaPhoto} to="/">
              <img alt="Instagram post 2" src={insta2} />
            </Link>
            <Link className={classes.instaPhoto} to="/">
              <img alt="Instagram post 3" src={insta3} />
            </Link>
            <Link className={classes.instaPhoto} to="/">
              <img alt="Instagram post 4" src={insta4} />
            </Link>
            <Link className={classes.instaPhoto} to="/">
              <img alt="Instagram post 5" src={insta5} />
            </Link>
          </div>
        </div>
      </div>
      ...
      <div className={classes.signUp}>
        <div className={classes.container}>
          <h2 className={classes.signUpHeading}>
            <img className={classes.emailIcon} alt="Email icon" src={email} />{" "}
